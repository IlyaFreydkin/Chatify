...
<template>
    <div class="journalView">
      ...
      <NavBar />
       ...
       <div id="container">
  <h1>&bull; Kontakt aufnehmen &bull;</h1>
  <div class="underline">
  </div>
  ...
  <form action="#" method="post" id="contact_form">
   ...
   <div class="subject">
    ...
    <div class="message">
      ...
      <textarea name="message" placeholder="Nachricht" id="message_input" cols="30" rows="5" required></textarea>
    </div>
    <div class="submit">
      <input type="submit" value="Verschicken" id="form_button" />
    </div>
  </form>
</div>
    </div>
