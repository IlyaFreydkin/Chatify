DOCKER_IMAGE=chatify_app
SQL_IMAGE=chatify_sqlserver
# Use INTERNAL port for the communication inside the docker network (1433 not 11433)
CONN_STR="Server=10.0.38.3,13306;Initial Catalog=ChatifyDB;User Id=sa;Password=SqlServer2019;TrustServerCertificate=true"
...
docker run -d -p 13306:3306 --network=sqlserver_network --ip=10.0.38.3 --name $SQL_IMAGE \
